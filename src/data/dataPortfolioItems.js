...
<br>Plus I will correct the mistake in SCSS in which I ranked the code, being a good habit.</p>`,
    ...
    },
    {
        ...
        description: `<p>Game created with JS objects, classes, JavaScript, HTML, CSS.</p>`,
    ...
    },
    {
        ...
        description: `<p>Game Project made with JavaScript, HTML, CSS.</p>`,
    ...
    {
        title: "Clock Project",
        description: `<p>Project made with JavaScript, HTML, CSS, asynchronous function.</p>`,
    ...
    },
    {
        ...
        description: `<p>Project with a form that fetch images. HTML, CSS, JavaScript.</p>`,
    ...
    },
    {
        ...
        description: `<p>For this project I used JavaScript Objects, Classes and Vite</p>`,
    ...
    {
        title: "Shop Site",
        description: `<p>Shop Site created with HTML and CSS.</p>`,
    ...
    },
    {
        ...
        description: `<p>Small Project where I worked on cookies.</p>`,
    ...
    },
    {
        ...
        description: `<p>Small Project where I worked on Browser Object Model.</p>`,
    ...
    {
        title: "Blog Project",
        description: `<p>An blog created with HTML and CSS.</p>`,
    ...
    {
        title: "Workshop site",
        description: `<p>Workshop created within the IT informal school courses. I used HTML and CSS.</p>`,
